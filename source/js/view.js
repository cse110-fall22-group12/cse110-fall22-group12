...
function construct_body() {
  ...
  document.getElementsByClassName('dish-name')[0].querySelector('h1').innerHTML = data.name;
  document.getElementsByClassName('block')[0].querySelector('p').innerHTML = data.ingredients;
  document.getElementsByClassName('block')[1].querySelector('p').innerHTML = data.steps;
  document.getElementsByClassName('block')[2].querySelector('p').innerHTML = data.notes;
}
/**
 * set up all the functilnalities for home button, edit button and
 * delete button.
...
function init() {
  ...
  document.getElementById('view-page-edit-button').addEventListener('click', function (event) {
  ...
  document.getElementById('yes-delete-button').addEventListener('click', function (event) {
    delete_selected_data();
    window.location.href = 'home.html';
  });
